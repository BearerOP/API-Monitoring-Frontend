  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to right, #a8c0ff, #000)' }}
      >
        <main className="flex flex-col h-full justify-center items-start px-6 py-24 sm:py-32 lg:px-8">
          <div className="">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-x-6">
              ...
              <Link
                to={'/dashboard'}
                className="mt-4 underline text-sm font-semibold text-gray-900 hover:text-violet-900 transition-colors "
              >
                Dashboard
              </Link>
            </div>
