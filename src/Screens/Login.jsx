...
import svgImage from '../assets/images/undraw_authentication_re_svpt.svg'; // Adjust the path if necessary
import bgImage from '../assets/images/mesh_background.png'; // Adjust the path if necessary
import '../Css/Login.css'; // Ensure to create and import this CSS file
    ...
    return (
        <div className="login-container">
            <div className="login-card">
                <h1 className="login-title">Log in to UpStatus</h1>
                <p className="login-subtitle">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint</p>
