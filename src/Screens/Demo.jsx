    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-violet-50 to-violet-100 dark:from-violet-900 dark:to-violet-950 text-violet-900 dark:text-violet-50 transition-colors duration-300">
      <header className="px-4 lg:px-6 h-14 flex items-center backdrop-blur-md bg-white/30 dark:bg-violet-950/30 sticky top-0 z-50">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <Link
            href="#features"
            className="text-sm font-medium hover:text-violet-600 dark:hover:text-violet-300 transition-colors"
            prefetch={false}
          >
            Features
          </Link>
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 relative z-10">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeIn}
              >
                Real-time monitoring, instant alerts, and powerful analytics for
                your APIs. Stay ahead of issues 24/7.
              </motion.p>
        ...
        <section
          id="features"
          className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-violet-900"
        >
              ...
              {[
                {
                  ...
                  description:
                    'Track API performance with millisecond precision',
                },
                {
                  icon: Zap,
                  title: 'Instant Alerts',
                  description: 'Get notified immediately when issues arise',
                },
                {
                  icon: Shield,
                  title: 'Advanced Security',
                  description: 'Ensure your APIs are secure and compliant',
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
        ...
        <section
          id="pricing"
          className="w-full py-12 md:py-24 lg:py-32 bg-violet-50 dark:bg-violet-950"
        >
          <div className="container px-4 md:px-6">
            <motion.h2
              className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-purple-600 dark:from-violet-400 dark:to-purple-400"
            ...
            >
              {[
                ...
                >
                  <Card
                    className={`${plan.featured ? 'bg-gradient-to-br from-violet-500 to-purple-600 text-white' : 'bg-white dark:bg-violet-900'} border-none shadow-lg hover:shadow-xl transition-shadow duration-300`}
                  >
                    <CardHeader>
                      <CardTitle
                        className={`text-2xl font-bold ${plan.featured ? 'text-white' : 'text-violet-800 dark:text-violet-200'}`}
                      >
                        {plan.title}
                      </CardTitle>
                      <CardDescription
                    ...
                    <CardContent>
                      <div
                        className={`text-4xl font-bold mb-2 ${plan.featured ? 'text-white' : 'text-violet-800 dark:text-violet-200'}`}
                      >
                        {plan.price}
                      </div>
                      <p
                      ...
                      <Button
                        className={`mt-4 w-full ${plan.featured ? 'bg-white text-violet-600 hover:bg-violet-100' : 'bg-violet-600 text-white hover:bg-violet-700'}`}
                      >
                        Choose Plan
                      </Button>
                    </CardContent>
      ...
      <footer className="w-full py-6 bg-violet-100 dark:bg-violet-900 text-violet-800 dark:text-violet-200">
        <div className="container px-4 md:px-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="flex gap-4 mt-4 md:mt-0">
            <Link
              href="#"
              className="text-sm hover:text-violet-600 dark:hover:text-violet-300 transition-colors"
              prefetch={false}
            >
              Terms of Service
            </Link>
